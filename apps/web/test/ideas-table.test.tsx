...
import { boards, ideas } from '@/lib/mock'
...
describe('IdeasTable selection', () => {
  it('marks exactly one row current', () => {
    ...
    render(<IdeasTable rows={ideas} boards={boards} selectedId={SELECTED.id} />)
