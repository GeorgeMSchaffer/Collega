...
public sealed class AuthService : IAuthService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var auditEvent = AuditEvent.Create(eventType, "User", message, nowUtc, organizationId, attribution.ActorUserId, entityId, metadataJson, attribution.OnBehalfOfUserId);
