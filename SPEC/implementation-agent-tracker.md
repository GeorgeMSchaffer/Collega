...
## Current Status
**Verified 2026-08-15 against `3c09afa` (`feature/065-viewas-test-harness`, 5 commits ahead of `dev` at `0858032`).** Keep this section a table plus short blocks — see Maintenance Rule at the end of this file.
