...
**Carried out of this sprint deliberately:** the `ViewAsAuth` test-harness leak, moved to `sprints/sprint-06.5-bug-fixes-and-tweaks.md` as scope item 1. It is a test-quality issue, not a product defect, and its blast radius (5 test classes, 82 call sites) did not belong in an already-large diff.
