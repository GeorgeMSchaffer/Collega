...
| 5 | PostgreSQL migration (SQL Server → Postgres) + code-review hardening batch (folded in 2026-08-11) | `SPEC/sprints/sprint-05-postgres-migration.md` | Not started | Small–Medium |
