    ...
    <div class="work">
      ...
      <div data-when="empty">
        <div class="empty">
          ...
          <a class="btn" href="#" data-go="comp-p-focus-roadmap.html#s-board">Open the ideas board</a>
        </div>
      </div>
...
@@DESK:roadmap@@
  <div class="main">
    <div class="topbar"><span class="crumb">Delivery / <b>Roadmap</b></span><span class="spacer"></span>
      ...
      <button class="btn pri" data-roles="OrgAdmin" data-when="normal">Add outcome</button>
      <span class="deniedwrap" data-roles="SiteAdmin" data-when="normal">
    ...
    <div class="work">
      ...
      <div data-when="empty">
        <div class="empty">
          ...
          <span class="deniedwrap" data-roles="SiteAdmin"><button class="btn pri" aria-disabled="true" aria-describedby="p-why-rm-e-sa">Add the first outcome</button><span class="denied" id="p-why-rm-e-sa">Act as an Acme Robotics administrator to add one</span></span>
          <span class="deniedwrap" data-roles="User ReadOnly"><button class="btn pri" aria-disabled="true" aria-describedby="p-why-rm-e">Add the first outcome</button><span class="denied" id="p-why-rm-e">Administrators only</span></span>
        </div>
      </div>
      ...
      <div data-when="normal" class="panel">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td><span class="key">CLG-107</span></td><td><a class="t" href="#">Publish the reporting data dictionary</a></td><td><span class="marker"><span class="dot" style="background:var(--green)"></span>Complete</span></td><td class="num">11</td><td><span class="marker"><span class="dot" style="background:var(--teal)"></span>Medium</span></td></tr>
            <tr><td><span class="key">CLG-111</span></td><td><a class="t" href="#">Archive the manual Friday template</a></td><td><span class="marker"><span class="dot" style="background:var(--green)"></span>Complete</span></td><td class="num">11</td><td><span class="marker"><span class="dot"></span>Low</span></td></tr>
...
@@DESK:sprint@@
  ...
  <aside class="inspector" aria-label="Set outcome">
    ...
    <div class="insp-foot">
      ...
      <span class="deniedwrap" data-roles="SiteAdmin" style="flex:1"><button class="btn pri" aria-disabled="true" aria-describedby="p-why-gr-sa">Move issue</button><span class="denied" id="p-why-gr-sa">Act as an Acme Robotics administrator</span></span>
      <span class="deniedwrap" data-roles="User ReadOnly" style="flex:1"><button class="btn pri" aria-disabled="true" aria-describedby="p-why-gr">Move issue</button><span class="denied" id="p-why-gr">Administrators only</span></span>
