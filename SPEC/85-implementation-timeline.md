...
| 7. Blazor Client Experience | Bug fixes, header/nav, Settings rename + list/form-swap, Boards list, full Kanban rebuild (drag/drop, column reorder, overlay, optimistic upvote/status, multi-assignee + tag selectors), primary-nav styling, Idea Fields settings, uniform search/pagination (`BE-3`/`BE-4`) | 10–14 | Epics 2–5 (final polish after all) | T042–T045, `BE-3`, `BE-4` |
