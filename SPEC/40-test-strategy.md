...
- Title-click navigation: verify clicking the card title navigates to the full-page Idea Detail view (`/ideas/{ideaId}/edit`); verify the page displays all fields (title, priority, Idea Type, Business Impact, due date, description, assignees, tags, mentions, comments) and provides role-appropriate actions.
