...
/// <summary>Factory helpers for domain entities used across the repository tests.</summary>
internal static class Build
{
    ...
    public static Status Status(Guid organizationId, string name = "New", string color = "#64748B", int sortOrder = 10) =>
        Domain.Statuses.Status.Create(organizationId, name, color, sortOrder, Now);

    public static Board Board(Guid organizationId, IReadOnlyList<Guid> orderedStatusIds, string name = "Ideas", bool allowUserStatusUpdate = true) =>
